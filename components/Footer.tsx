...
const footerLinks = {
  ...
  Resources: [
    ...
    { label: "Support", href: "https://t.me/ccbotwalletchat" },
    { label: "Email", href: "mailto:support@ccbot.io" },
  ],
  Community: [
    { label: "Community Chat", href: "https://t.me/ccbotwalletchat" },
    { label: "Announcements", href: "https://t.me/ccbotwallet" },
    { label: "Telegram Bot", href: "https://t.me/ccbotwallet_bot" },
  ],
  Company: [
    { label: "About", href: "#" },
    { label: "Careers", href: "#" },
